...
class ListaExercicio : ComponentActivity() {
    private val viewModel by viewModels<ListaExercicioViewModel>()
...
@Composable
fun GaleriaExercicio(
    viewModel: ListaExercicioViewModel,
    navController: NavHostController,
    modifier: Modifier = Modifier
) {
    val listaExerciciosUiState by viewModel.listaExercicioUiState.collectAsState()

    val treinosDiarios = listaExerciciosUiState.treinosDiarios
    val isLoading = listaExerciciosUiState.isLoading
    ...
    if (isLoading) {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.lista_exercicios),
                fontFamily = MavenPro,
                fontSize = 20.sp,
            ...
            if (listaExerciciosUiState.rotinaDiaria == null) {
                Text(
                    text = "Nenhum exercício para realizar hoje!",
