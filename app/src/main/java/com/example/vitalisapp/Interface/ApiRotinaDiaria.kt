...
interface ApiRotinaDiaria {
    ...
    suspend fun showByRotinaSemanalId (@Path("id") idRotinaSemanal: Int): Response<List<RotinaDiariaExibitionDto>>
    ...
    suspend fun showByUsuarioId (@Path("id") idUsuario: Int): Response<List<RotinaDiariaExibitionDto>>
